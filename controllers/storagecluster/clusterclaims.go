...
// zhou: create "clusterv1alpha1.ClusterClaim" CR for OCM.
//       Including cluster name, odf version, fs name ...
...
// zhou: verify that CRD "clusterclaims.cluster.open-cluster-management.io" has been installed.
...
func (obj *ocsClusterClaim) ensureCreated(r *StorageClusterReconciler, instance *ocsv1.StorageCluster) (reconcile.Result, error) {
	...
	// zhou: if OCM CRD "clusterv1alpha1.ClusterClaim" installed.
